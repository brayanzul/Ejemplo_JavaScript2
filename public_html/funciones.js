...
/**
 * Funcion que valida si elusuario quiere salir del sitio o no  
 */
function validaSalir(){
    if(confirm("Desea salir del sitio")) {
        alert("Nos vamos a google");
        return true; //regresamos verdederopara salir
    }
    else{
